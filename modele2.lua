...
function getNet(image_width,image_height)
	...
	Timnet:add(nn.Linear(4*nbFilter*width*height, 1000))             -- fully connected layer 
	Timnet:add(nn.ReLU())                       
	Timnet:add(nn.Linear(1000, 1000))
	Timnet:add(nn.ReLU())                       
	Timnet:add(nn.Linear(1000, 10))                   -- 10 is the number of outputs of the network 
